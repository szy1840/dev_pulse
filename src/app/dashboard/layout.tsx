...
import { syncProfile, getActiveTeam, getMyTeams, getProfileTimezone, getProfileLocale } from "@/lib/auth";
...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const [savedTimezone, savedLocale] = await Promise.all([
    getProfileTimezone(user.id),
    getProfileLocale(user.id),
  ]);
  ...
  return (
    <div className="min-h-screen">
      ...
      <LocaleBootstrap savedLocale={savedLocale} />
